...
function Required(_, context) {
    ...
    context.addInitializer(function () {
        ...
        registeredValidators[className] = __assign(__assign({}, registeredValidators[className]), (_a = {}, _a[context.name] = ['required'], _a));
    });
}
function PositiveNumber(_, context) {
    var className;
    context.addInitializer(function () {
        var _a;
        className = this.constructor.name;
        registeredValidators[className] = __assign(__assign({}, registeredValidators[className]), (_a = {}, _a[context.name] = ['positive'], _a));
